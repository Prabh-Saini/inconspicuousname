...
from math import ceil# rewards login back up - should work
import argparse
import urllib.parse
from datetime import datetime
from inspect import currentframe
...
skip: int = 0  # default: 0  THIS WILL RETURN AN ERROR WHEN ALL ACCOUNTS ARE COMPLETED AND IT TRIES TO DO THE SKIPPED ONES
